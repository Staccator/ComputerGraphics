...
namespace ShapeDrafter.Graphics
{
    ...
    public static class Geometry
    {
        ...
        public static bool IsTriangleClockwise(Vector2F v1, Vector2F v2, Vector2F v3)
        {
            var firstX = v2.X - v1.X;
            var firstY = v2.Y - v1.Y;
            var secondX = v3.X - v2.X;
            var secondY = v3.Y - v2.Y;
            float crossProduct = firstX * secondY - firstY * secondX;
